...
const JobDescription = () => {
    ...
    const userApplication = allAppliedJobs.find((application) => {
        ...
        return appliedJobId === singleJob?._id;
    });
    const applicationStatus = userApplication?.status?.toLowerCase() || null;
    const isIntiallyApplied = !!applicationStatus || singleJob?.applications?.some(application => application.applicant === user?._id) || false;
    ...
    const getStatusLabel = () => {
        if (!applicationStatus && !isApplied) return 'Apply Now';
    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <div className='flex items-center gap-2 mt-4'>
                        ...
                        <Badge className={'text-[#7209b7] font-bold'} variant="ghost">{formatSalary(singleJob?.salary)}</Badge>
                    </div>
                </div>
                <Button
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Salary: <span className='pl-4 font-normal text-gray-800'>{formatSalary(singleJob?.salary)}</span></h1>
